        ...
        <AccountLayout2 bottomLinks={<BottomLink />}>
            <div className="text-center m-auto">
                ...
                <p className="text-muted mb-4">
                    {t(`A email has been send to`)} <b>youremail@domain.com</b>. {t('Please check for an email from company and click on the included link to reset your password.')}
                </p>
                <form>
                    <div className="mb-0 d-grid text-center">
                        <Link to="../login2" className="btn btn-primary">
